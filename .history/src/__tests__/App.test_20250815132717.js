...
describe('RBFCalculator App', () => {
  ...
  test('displays all input fields', () => {
    ...
    expect(screen.getByLabelText('Repayment Obligation')).toBeInTheDocument();
    expect(screen.getByLabelText('Cost of Capital')).toBeInTheDocument();
  ...
  test('allows input changes for non-calculated variables', () => {
    ...
    const loanPrincipleInput = screen.getByLabelText('Amount Received');
