            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200">
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <ul className="list-disc pl-5 space-y-1 text-gray-700">
                  ...
                  <li>Factor Rate: <span className={getFactorRateColorClass(values.factorRate)}>{formatValue('factorRate', values.factorRate)}</span> (pay back <span className={getFactorRateColorClass(values.factorRate)}>{formatValue('factorRate', values.factorRate)}</span>x borrowed amount)</li>
